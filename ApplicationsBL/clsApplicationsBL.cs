...
namespace ApplicationsBusinessLayer
{
    ...
    public class clsApplication
    {
        ...
        public static bool IsApplicationHasALicense(int ApplicationID) { return clsApplicationsDataAccess.IsApplicationHasALicense(ApplicationID); }

        public static int GetPersonIDByApplicationID(int ApplicationID) { return clsApplicationsDataAccess.GetPersonIDByApplicationID(ApplicationID); }
        public static int GetApplicationTypeIDByApplicationID(int ApplicationID) { return clsApplicationsDataAccess.GetApplicationTypeIDByApplicationID(ApplicationID); }
