...
namespace LicensesBusinessLayer
{
    ...
    public class clsLicense
    {
        ...
        public static bool IsLicenseDetained(int LicenseID) { return clsLicensesDataAccess.IsLicenseDetained(LicenseID); }
        public static int GetLicenseIDByApplicationID(int ApplicationID) { return clsLicensesDataAccess.GetLicenseIDByApplicationID(ApplicationID); }
        public static bool IsLicenseHasInternationalLicense(int DriverID) { return clsLicensesDataAccess.IsLicenseHasInternationalLicense(DriverID); }
        public static int GetApplicationIDByLicenseID(int LicenseID) { return clsLicensesDataAccess.GetApplicationIDByLicenseID(LicenseID); }
        public static int GetLicenseClassIDByLicenseID(int LicenseID) { return clsLicensesDataAccess.GetLicenseClassIDByLicenseID(LicenseID); }
