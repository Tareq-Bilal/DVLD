...
namespace InternationalLicensesBusinessLayer
{
    ...
    public class clsInternationalLicense
    {
        ...
        public static int GetInternationalLicenseIDByDriverID(int DriverID) { return clsInternationalLicensesDataAccess.GetInternationalLicenseIDByDriverID(DriverID); }

        public static DataTable GetInternationalDrivingLicenseApplicationByFilter(string SerachingInfo, string Filter)
        { return clsInternationalLicensesDataAccess.GetInternationalDrivingLicenseApplicationByFilter(SerachingInfo, Filter); }
